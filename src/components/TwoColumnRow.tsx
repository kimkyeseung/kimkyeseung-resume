...
export const TwoColumnRow: FC<Props> = ({ leftSide, children }) => {
  return (
    <div className="container flex gap-10 flex-wrap md:flex-nowrap print:flex-nowrap">
      <div className="basis:auto md:basis-1/4 print:basis-1/4 relative md:shrink-0 print:shrink-0">
